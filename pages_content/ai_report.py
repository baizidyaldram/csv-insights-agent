...
def render():
    ...
    @media (prefers-color-scheme: dark) {
        ...
        /* Fix the report container background */
        .report-wrapper {
...
Keep the total under 700 words. No markdown tables whatsoever."""
    ...
    if st.session_state.get("ai_report"):
        ...
        # Updated container with better dark mode support
        st.markdown(
            f"""<div class="report-wrapper" style="background:#FFFBF5;border:1.5px solid #D85A30;border-radius:16px;
                            padding:2rem;line-height:1.8;font-size:0.95rem;color:#221E1B;">
...
def format_report_html(text: str) -> str:
    ...
    # Return wrapped in report-container class for dark mode targeting
    return f'<div class="report-container">{text}</div>'
